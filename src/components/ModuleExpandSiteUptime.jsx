                    ...
                    <Tabs>
                        ...
                        <TabPanel>
                            <div style={{display:"flex",float:"right", marginBottom:24+'px'}}>
                                <label className="common-label" style={{marginRight:24+'px',marginTop:5+'px'}}>Set Frequency</label>
                                ...
                                <div>
                                    ...
                                    <button style={{marginLeft:24+"px", height:30+'px', padding:"4px 14px"}} class="outline-btn" >Export</button>
                                </div>
                            </div>
                            <br/>
                                    ...
                                    <>
                                        ...
                                        <div className="row">
                                            <div className="col-md-12">
                                                <div style={{display:"flex", marginTop:24+'px', justifyContent:"space-around"}}>
